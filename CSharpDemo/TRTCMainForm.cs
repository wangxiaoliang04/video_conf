...
namespace TRTCCSharpDemo
{
    public partial class TRTCMainForm : Form, ITRTCCloudCallback, ITRTCLogCallback,ITRTCAudioFrameCallback
    {
        ...
        private bool mIMWinOpenClose = false;
        ...
        public TRTCMainForm(TRTCLoginForm loginForm)
        {
            ...
            int right = this.panel1.Right;
            //int width = this.panel1.Width;
            this.Width = right;
            mIMWinOpenClose = false;

            DataManager.GetInstance().ImInit();
            ...
            this.richTextBox2.Text = "11111111111\n22222222222\naaaaaaaaasssdd\njjkjjjj";
        ...
        private void IMChatSwitch_Click(object sender, EventArgs e)
        {
            DataManager.GetInstance().CreateGroup();
            if (false == mIMWinOpenClose)
            {
                int right = this.panel1.Right;
                this.Width = right+300;
                mIMWinOpenClose = true;
            }
            else
            {
                int right = this.panel1.Right;
        ...
        {
            DataManager.GetInstance().Send_Message();
        }
